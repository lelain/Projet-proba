...
\end{theorem}
 ...
 On veut simuler des données qui suivent une loi de Weibull de paramètres $(\beta_0,\eta_0)$ conditionnée par ${X_i >c}$. Cela donne une fonction de répartition $F$ de la forme :
